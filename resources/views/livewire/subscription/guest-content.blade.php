    ...
    <div class="card h-100 mx-2 my-2">
        <div class="card-header bg-transparent">
            ...
            <div style="display: flex; flex-direction: row; justify-content: space-between">
                ...
                <a class="btn btn-sm btn-primary-soft text-primary disabled" >GRATIS</a>
            </div>  
        </div>
        <div class="card-body p-0">
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                    ...
                    Acceso a informacion de eventos por invitacion
                </li>
                <li class="list-group-item">
                    <i class="text-secondary me-2" data-feather="check-circle"></i>
                    Busqueda y compra de fotos
                </li>
                <li class="list-group-item">
                    <i class="text-secondary me-2" data-feather="check-circle"></i>
                    Notificacion en las fotos donde apareces
                </li>
                <li class="list-group-item">
                    <i class="text-secondary me-2" data-feather="check-circle"></i>
