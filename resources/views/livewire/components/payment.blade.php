                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <div style="display: flex; flex-direction: column">
                                            ...
                                            <input class="form-control form-control-solid" type="text" id="card-number" name="card-number"
                                        ...
                                        <div
                                            ...
                                            <div style="display: flex; flex-direction: column">
                                                ...
                                                <input class="form-control form-control-solid" type="text" id="expiration-date" name="expiration-date"
                                                    placeholder="MM/AA" required>
                                            </div>
                                            <div style="display: flex; flex-direction: column">
                                                <span>CVV/CVC</span>
                                                <input class="form-control form-control-solid" type="text" id="cvc" name="cvc"
                                                    placeholder="Código de seguridad" required>
                                            </div>
                                        </div>
                                        <div>
                                            <button class="btn btn-dark" type="button" style="margin-top: 15px; width: 100%">PAGAR 100 bs</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
