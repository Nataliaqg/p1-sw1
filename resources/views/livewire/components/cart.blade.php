        ...
        <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
            ...
            <a class="dropdown-item dropdown-notifications-item" href="#!">
                ...
                <div class="dropdown-notifications-item-content">
                    <div style="display: flex; flex-direction: row">
                        ...
                        <span style="margin-left: 5px">12 bs</span>
                    </div>
                    <div style="display: flex; flex-direction: row">
            ...
            <a class="dropdown-item dropdown-notifications-item" href="#!">
                ...
                <div class="dropdown-notifications-item-content">
                    <div style="display: flex; flex-direction: row">
                        <div class="dropdown-notifications-item-content-text">Precio:</div>
                        <span style="margin-left: 5px">20 bs</span>
                    </div>
                    <div style="display: flex; flex-direction: row">
                        <div class="dropdown-notifications-item-content-text">Formato:</div>
                        <span style="margin-left: 5px">Impresa</span>
                    </div>
                </div>
            </a>
            {{-- TOTAL --}}
            <div class="dropdown-item dropdown-notifications-item">
                <div style="display: flex; flex-direction: row">
                    ...
                    <span style="margin-left: 5px">32 bs</span>
                </div>
            </div>
            <!-- Footer Link-->
